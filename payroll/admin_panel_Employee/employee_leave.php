        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Leave</h1>
...
<h1 style="text-align:center;" ><span  class="badge badge-primary">Leave Record</center></span></h1>
<?php
...
{echo"<script>alert('not data Added')</script>";
}	}?>
...
<input type="text"  name="emp_leave" class="form-control" id="leave" value="" required></td>
<br>
<input type="submit" value="add" class="btn btn-primary" name="leave"/>
