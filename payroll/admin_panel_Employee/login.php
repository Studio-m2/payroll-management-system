...
$query="select* from registration where  password=md5('$password') and email='$email' ";
...
$messagek='<span style="color:green;text-align:center;">you have successfully login</span>';
echo $messagek;
}
else
{
