...
<h1 style="text-align:center;" ><span  class="badge badge-primary">Department Record</center></span></h1>
<?php
...
Swal.fire({
                icon: 'success',
                title: 'Deparment has been Added successfully',
...
<br>
<input type="submit" value="Insert" class="btn btn-primary" name="depart"/>
</div>
