...
if(!empty($_POST['update'])&& !empty($_GET['id'])){
	...
	$query_update="update employee_department set department_title='$department' where id='$id'";
	//echo $query_update;
...
?>
 ...
 {
 $id=$_GET['id'];
$query="select* from employee_department where id='$id'";
...
<h1 style="text-align:center;" ><span  class="badge badge-primary">Edit Department</center></span></h1>
